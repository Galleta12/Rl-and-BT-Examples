...
public class WallJumpAgent : Agent
{
    ...
    public virtual void Start(){
        ...
        tree._globalBlackBoard.fallingForce = fallingForce;
        tree._globalBlackBoard.agentObject = gameObject;
        tree._globalBlackBoard.m_AgentRb = m_AgentRb;
        tree._globalBlackBoard.m_ShortBlockRb = m_ShortBlockRb;
        tree._globalBlackBoard.wallJumpSettings= m_WallJumpSettings;




        tree._globalBlackBoard.SetRewardEndEpisode += EventSetRewardEndEpisode;
...

    {
        ...
        tree._globalBlackBoard.smallGrounded = DoGroundCheck(true);
        tree._globalBlackBoard.largeGrounded = DoGroundCheck(false);

        tree._globalBlackBoard.dirToGo = Vector3.zero;
        tree._globalBlackBoard.rotateDir = Vector3.zero;
        tree._globalBlackBoard.dirToGoForwardAction = act[0];
        tree._globalBlackBoard.rotateDirAction = act[1];
        tree._globalBlackBoard.dirToGoSideAction = act[2];
        tree._globalBlackBoard.jumpAction = act[3];
    ...
    private void EventSetRewardEndEpisode(){
        Debug.Log("No Reward");
        SetReward(-1f);
        EndEpisode();
        ResetBlock(m_ShortBlockRb);
